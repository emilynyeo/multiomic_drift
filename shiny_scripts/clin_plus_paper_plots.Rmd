...
for (omic_name in names(omic_dfs)) {
  ...
  models <- list(
    `Basic + Clinical`  = lmer_basic_meta_b,
  ...
  lmer_models <- list(
     c("lmer_basic_b", "lmer_basic_meta_b"),
  ...
  dplyr::mutate(
    Compared_Model = dplyr::recode(
       model_comparison,
       "lmer_basic_b vs lmer_basic_meta_b" = "Basic + Clinical",
  ...
  custom_order_clin_plus <- c("Basic + Clinical", 
                    "Clinical + Pathway", 
                    "Clinical + Taxa",
                    "Clinical + Micom", 
                    "Clinical + Metabo", 
