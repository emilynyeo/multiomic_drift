...
ggsave(
  filename = output_file_combined,
  plot = combined_all_plots,
  width = 20,     # Adjust as needed for your layout
  height = 10,    # Adjust as needed for your layout
  dpi = 600
)
...
for (type in names(all_ft_dfs)) {
  ...
  for (ft_name in names(ft_set)) {
    ...
    theme(
      ...
      axis.title.x = element_text(size = 25, margin = ggplot2::margin(t = 12)),
...
merf_long_plots <- merf_plots[c(2, 6, 7, 5)]
combined_merf_long_plot <- wrap_plots(merf_long_plots, ncol = 1, nrow = 4, 
                                      #widths = c(0.95,0.95),
                                      heights = c(0.95,0.95)) +
...
merf_delta_plots <- merf_plots[c(2, 6, 3, 5)]
...
png_name <- file.path(omic_out_dir, paste0("combined_merf_long_ft_plot_dot", ".png"))
ggsave(filename = png_name, plot = combined_merf_long_plot, width = 20, height = 30, dpi = 600)

png_name <- file.path(omic_out_dir, paste0("combined_merf_delta_ft_plot_dot", ".png"))
ggsave(filename = png_name, plot = combined_merf_delta_plot, width = 20, height = 30, dpi = 600)
```
