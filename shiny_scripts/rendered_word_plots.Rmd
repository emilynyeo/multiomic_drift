...
ggsave(paste0(omic_out_dir, "aov_feats_combined/basic_long_shap.png"), p, 
       width = 40, height = 40, dpi = 500, bg = 'white')
...
right_ysd <- seq(0.7, 0, length.out = 4)  # y positions for 4 plots
for (i in 1:4) {
  pd <- pd + draw_plot(bd[[i+2]], x = 0.52, y = 0.05 + right_ysd[i], width = 0.48, height = 0.215)
}
labelsd <- c("A.", "B.", "C.", "D.", "E.", "F.", "G.", "H.")
label_xd <- c(0.01, 0.01, 0.01, 0.01, rep(0.516, 4))
label_yd <- c(0.6+0.15+0.22, 
...
ggsave(paste0(omic_out_dir, "aov_feats_combined/basic_delta_shap.png"), pd, 
       width = 40, height = 40, dpi = 500, bg = 'white')
...
ggsave(paste0(omic_out_dir, "aov_feats_combined/clin_long_shap.png"), p_cl, 
       width = 40, height = 40, dpi = 500, bg = 'white')
...
ggsave(paste0(omic_out_dir, "aov_feats_combined/clin_delta_shap.png"), p_cd, 
       width = 40, height = 40, dpi = 500, bg = 'white')
