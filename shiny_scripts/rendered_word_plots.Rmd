...
for (omic_name in names(omic_dfs)) {
  ...
  sig_plot <- ggplot(r2_annotated,
    ...
    labs(title = glue("R² {omic_name_labels[[omic_name]]}"),
         ...
         #x = expression(R^2*" : Omic vs. Basic"),
         y = expression(R^2*" = Fixed Effect Variance")) +
    theme_minimal(base_size = 25) +
    theme(legend.position = "none",
          plot.margin = ggplot2::margin(t = 2, r = 2, b = 2, l = 2, unit = "cm"),
          axis.text.y = element_text(face = "bold", hjust = 1, size = 25),
          axis.text.x = element_text(face = "bold", size = 25, hjust = 1, angle = 45),
  ...
  # Save the sig plot
  ggsave(file.path(omic_out_dir, paste0(omic_name, "_basic_sig_plot.png")), 
...
# Save the Word file
print(doc, target = paste0(omic_out_dir, "anova_initial_combined.docx"))
```
...
# Save the plots
ggsave(filename = file.path(omic_out_dir, "combined_basic_plot.png"),
       plot = combined_basic_plot,
       width = 15, height = 12, dpi = 400)

ggsave(filename = file.path(omic_out_dir, "merf_basic_plot.png"),
       plot = merf_basic_plot,
       width = 7.5, height = 10, dpi = 400)

ggsave(filename = file.path(omic_out_dir, "gllass_basic_plot.png"),
...
# Save the Word file
print(doc, target = paste0(omic_out_dir, "anova_clinical_combined.docx"))
```
...
ggsave(filename = file.path(omic_out_dir, "combined_clin_plot.png"),
       plot = combined_sig_plot_clin_plus,
       width = 15, height = 12, dpi = 400)

ggsave(filename = file.path(omic_out_dir, "merf_clin_plot.png"),
       plot = merfs_sig_plot_clin_plus,
       width = 7.5, height = 10, dpi = 400)

ggsave(filename = file.path(omic_out_dir, "gllass_clin_plot.png"),
...
# Save to file
output_file_combined <- file.path(omic_out_dir, "Combined_ANOVA_Marginal_R2_base_clin.png")
...
png_name1 <- file.path(omic_out_dir, paste0("combined_merf_long_ft_plot_dot", ".png"))
ggsave(filename = png_name1, plot = combined_merf_long_plot, width = 20, height = 30, dpi = 600)

png_name2 <- file.path(omic_out_dir, paste0("combined_merf_delta_ft_plot_dot", ".png"))
ggsave(filename = png_name2, plot = combined_merf_delta_plot, width = 20, height = 30, dpi = 600)

png_name3 <- file.path(omic_out_dir, paste0("combined_merf_all_ft_plot_dot", ".png"))
...
ggsave(paste0(omic_out_dir, "merf_ft_plot_combined_all.png"), merf_cow_plot_ft, 
...
clin_lass_delta <- lass_plots_delta[c(7, 8)]
...
ggsave(paste0(omic_out_dir, "lasso_ft_plot_all_combined.png"), lass_cow_plot_ft, 
...
file_path <- file.path(omic_out_dir, "venn_grid_overall_title.png")
