...
gl_lasso_long <- read.csv("/Users/emily/projects/research/Stanislawski/comps/mutli-omic-predictions/play_scripts/2.models/glmmlasso/may_basic_plus/long/may_basic_plusapril_long_predictions_df.csv") %>%
...
gtsave(final_anova_table_initial, 
       filename = paste0(omic_out_dir, "anova_initial_table.png"))
...
# Show plot
print(final_plot)
ggsave(paste0(omic_out_dir, "anova_initial_combined.png"), final_plot, 
...
output_file <- file.path(omic_out_dir, "ANOVA_Marginal_R2_Comparison_initial.png")
