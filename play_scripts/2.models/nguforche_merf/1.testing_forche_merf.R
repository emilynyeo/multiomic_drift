# Mixed Effect Machine Learning: a framework for predicting longitudinal change in hemoglobin A1c, in Journal of Biomedical Informatics, 2018
...
require(flexmix)
require(gplots)
# require(bayou) this package does not exist 
