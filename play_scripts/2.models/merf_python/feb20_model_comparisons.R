...
for (model_pair in merf_long_lmer_models) {
...
writeLines(html_table, "/Users/emily/projects/research/Stanislawski/comps/mutli-omic-predictions/play_scripts/2.models/merf_python/merf_plots/long_combined/merf_long_anova_table.html")
