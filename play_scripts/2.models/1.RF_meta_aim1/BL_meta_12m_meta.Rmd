---
title: "BL_meta_predicts_12m_BMI"
author: "Emily Yeo"
date: "`r Sys.Date()`"
...
m6_results <- train_and_save_models(
  ...
  train_control,
  "BL_meta_predicts_12m_bmi_regression")
```
...
genus_results <- train_and_save_models(
  ...
  "outcome_BMI_fnl_train_long.x",
  train_control,
  "BL_meta_12m_bmi_no_redundant_regression")
```
...
file_paths <- list(
  # genus
  m6_all_omic_g_ra_regression_beta = "BL_meta_predicts_12m_bmi_regression_beta.csv",
  m6_all_omic_g_ra_regression_feature_importance = "BL_meta_predicts_12m_bmi_regression_feature_importance.csv",
  m6_all_omic_g_ra_regression_metrics = "BL_meta_predicts_12m_bmi_regression_metrics.csv",
  # genus no redundant
  m6_all_omic_g_ra_regression_no_redundant_beta = "BL_meta_12m_bmi_no_redundant_regression_beta.csv",
  m6_all_omic_g_ra_regression_no_redundant_feature_importance = "BL_meta_12m_bmi_no_redundant_regression_feature_importance.csv",
  m6_all_omic_g_ra_regression_no_redundant_metrics = "BL_meta_12m_bmi_no_redundant_regression_metrics.csv"
)
...
pdf("/Users/emily/projects/research/Stanislawski/comps/mutli-omic-predictions/zachs_rerun/drift_fs/figures/m12/feb10_BL_meta_predicts_12m_bmi_regression.pdf", width = 7, height = 7)
...
pdf("/Users/emily/projects/research/Stanislawski/comps/mutli-omic-predictions/zachs_rerun/drift_fs/figures/m12/feb10_BL_meta_predicts_12m_bmi_no_redundant_regression.pdf", width = 7, height = 7)
...
create_feature_plot(
  ...
  "/Users/emily/projects/research/Stanislawski/comps/mutli-omic-predictions/zachs_rerun/drift_fs/figures/m12/feb10_BL_meta_m12BMI_feature_plot.pdf")

create_feature_plot(
  all_omic_genus_no_rendundant_features,
  "Top 10 Features - Non Redundant BL omics predicts 6m BMI",
  "/Users/emily/projects/research/Stanislawski/comps/mutli-omic-predictions/zachs_rerun/drift_fs/figures/m12/feb10_BL_meta_m12BMI_feature_plot_no_redundant.pdf")
```
