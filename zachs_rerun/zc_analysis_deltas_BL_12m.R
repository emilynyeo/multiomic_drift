...
imputed <- remove_columns(
  imputed_BL_12m,
  columns_to_remove = c("subject_id", "SampleID", "Weight (12m-BL)"))
...
genus_results <- train_and_save_models(
  ...
  "BMI (12m-BL)",
  train_control,
  "deltas_BMI_BL_12m_g_ra_reg_no_redundant")
...
file_paths <- list(
  # genus
  deltas_BMI_BL_12m_g_ra_regr_beta = "deltas_BMI_BL_12m_g_ra_regr_beta.csv",
  deltas_BMI_BL_12m_g_ra_regr_feature_importance = "deltas_BMI_BL_12m_g_ra_regr_feature_importance.csv",
  deltas_BMI_BL_12m_g_ra_regr_metrics = "deltas_BMI_BL_12m_g_ra_regr_metrics.csv",
  # genus no redundant
  deltas_BMI_BL_12m_g_ra_reg_no_redundant_beta = "deltas_BMI_BL_12m_g_ra_reg_no_redundant_beta.csv",
  deltas_BMI_BL_12m_g_ra_reg_no_redundant_feature_importance = "deltas_BMI_BL_12m_g_ra_reg_no_redundant_feature_importance.csv",
  deltas_BMI_BL_12m_g_ra_reg_no_redundant_metrics = "deltas_BMI_BL_12m_g_ra_reg_no_redundant_metrics.csv"
)
...
top_20_features <- get_top_n_features_all_models(data_list$deltas_BMI_BL_12m_g_ra_regr_feature_importance, 20)
print(top_20_features)

top_20_features_no_r <- get_top_n_features_all_models(data_list$deltas_BMI_BL_12m_g_ra_reg_no_redundant_feature_importance, 20)
...
create_feature_plot(
  ...
  "drift_fs/figures/deltas/jan22_deltas_BL_12m_all_g_feature_plot.pdf")

create_feature_plot(
  all_omic_genus_no_rendundant_features,
  "Top 10 Features - Non Redundant Genus + All omics",
  "drift_fs/figures/deltas/jan22_deltas_BL_12m_all_g_no_re_feature_plot.pdf")
...
pdf("drift_fs/figures/deltas/jan22_deltas_BL_12m_all_g.pdf", width = 7, height = 7)
...
pdf("drift_fs/figures/deltas/jan22_deltas_BL_12m_all_g_no_re.pdf", width = 7, height = 7)
