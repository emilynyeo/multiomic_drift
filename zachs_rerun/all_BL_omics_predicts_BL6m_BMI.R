...
m6_results <- train_and_save_models(
  ...
  "bmi_bL_6m",
  train_control,
  "bmi_bL_6m_BL_omic_g_ra_regression")
...
genus_results <- train_and_save_models(
  ...
  "bmi_bL_6m",
  train_control,
  "bmi_bL_6m_BL_omic_g_regression_no_redundant")
...
file_paths <- list(
  # genus
  bmi_bL_6m_BL_omic_g_ra_regression_beta = "bmi_bL_6m_BL_omic_g_ra_regression_beta.csv",
  bmi_bL_6m_BL_omic_g_ra_regression_feature_importance = "bmi_bL_6m_BL_omic_g_ra_regression_feature_importance.csv",
  bmi_bL_6m_BL_omic_g_ra_regression_metrics = "bmi_bL_6m_BL_omic_g_ra_regression_metrics.csv",
  # genus no redundant
  bmi_bL_6m_BL_omic_g_ra_regression_no_redundant_beta = "bmi_bL_6m_BL_omic_g_regression_no_redundant_beta.csv",
  bmi_bL_6m_BL_omic_g_ra_regression_no_redundant_feature_importance = "bmi_bL_6m_BL_omic_g_regression_no_redundant_feature_importance.csv",
  bmi_bL_6m_BL_omic_g_ra_regression_no_redundant_metrics = "bmi_bL_6m_BL_omic_g_regression_no_redundant_metrics.csv"
)
...
datasets <- list(
  "bmi_bL_6m_BL_omics_Genus_ra" = list(
    beta = data_list$bmi_bL_6m_BL_omic_g_ra_regression_beta,
    feature_importance = data_list$bmi_bL_6m_BL_omic_g_ra_regression_feature_importance,
    metrics = data_list$bmi_bL_6m_BL_omic_g_ra_regression_metrics
  ),
  "bmi_bL_6m_BL_omics_Genus_ra_No_Redundant)" = list(
    beta = data_list$bmi_bL_6m_BL_omic_g_ra_regression_no_redundant_beta,
    feature_importance = data_list$bmi_bL_6m_BL_omic_g_ra_regression_no_redundant_feature_importance,
    metrics = data_list$bmi_bL_6m_BL_omic_g_ra_regression_no_redundant_metrics
  )
)
...
top_20_features <- get_top_n_features_all_models(data_list$bmi_bL_6m_BL_omic_g_ra_regression_feature_importance, 20)
print(top_20_features)

top_20_features_no_r <- get_top_n_features_all_models(data_list$bmi_bL_6m_BL_omic_g_ra_regression_no_redundant_feature_importance, 20)
...
results_all <- extract_metrics(bmi_bL_6m_BL_omics_Genus_ra)
results_allno_re <- extract_metrics(bmi_bL_6m_BL_omics_Genus_ra_No_Redundant)
...
pdf("drift_fs/figures/BL_omic_predicting_BL6m_BMI/feb18_BLomic_BL6mBMI_g_data_list.pdf", width = 7, height = 7)
...
pdf("drift_fs/figures/BL_omic_predicting_BL6m_BMI/feb18_BLomic_BL6mBMI_g_data_list_no_re.pdf", width = 7, height = 7)
...
all_omic_genus_no_rendundant_features <- extract_top_features(datasets$`bmi_bL_6m_BL_omics_Genus_ra_No_Redundant)`)
all_omic_genus_features <- extract_top_features(datasets$bmi_bL_6m_BL_omics_Genus_ra)
...
create_feature_plot(
  ...
  "drift_fs/figures/BL_omic_predicting_BL6m_BMI/feb18_BLomic_BL6mBMI_g_feature_plot.pdf")

create_feature_plot(
  all_omic_genus_no_rendundant_features,
  "Top FI's - BL omics predicting BL-6m BMI change (non redundant)",
  "drift_fs/figures/BL_omic_predicting_BL6m_BMI/feb18_BLomic_BL6mBMI_g_no_rendundant_feature_plot.pdf")
...
top_models_list_all_omic_m12 <- bmi_bL_6m_BL_omics_Genus_ra$metrics %>%
  filter(DataType == "Test") %>%
  arrange(desc(R2)) %>%
  slice_head(n = 3) %>%
  pull(Model)

top_models_list_all_omic_m12_no_redundant <- bmi_bL_6m_BL_omics_Genus_ra_No_Redundant$metrics %>%
  filter(DataType == "Test") %>%
  arrange(desc(R2)) %>%
  slice_head(n = 3) %>%
  pull(Model)
