...
imputed <- remove_columns(
  imputed_BL_12m,
  columns_to_remove = c("subject_id", "BMI (6m-BL)", "BMI (12m-BL)",
                        "Weight (6m-BL)","Weight (12m-6m)",
                        "Glucose (6m-BL)",
...
m6_results <- train_and_save_models(
  ...
  "Weight (12m-BL)",
  train_control,
  "jan22_ALL_deltas_WT_BL_12m_g_ra_regr")
...
genus_results <- train_and_save_models(
  ...
  "Weight (12m-BL)",
  train_control,
  "jan22_ALL_deltas_WT_BL_12m_g_ra_no_redundant")
...
file_paths <- list(
  # genus
  deltas_WT_BL_12m_g_ra_regr_beta = "jan22_ALL_deltas_WT_BL_12m_g_ra_regr_beta.csv",
  deltas_WT_BL_12m_g_ra_regr_feature_importance = "jan22_ALL_deltas_WT_BL_12m_g_ra_regr_feature_importance.csv",
  deltas_WT_BL_12m_g_ra_regr_metrics = "jan22_ALL_deltas_WT_BL_12m_g_ra_regr_metrics.csv",
  # genus no redundant
  deltas_WT_BL_12m_g_ra_reg_no_redundant_beta = "jan22_ALL_deltas_WT_BL_12m_g_ra_no_redundant_beta.csv",
  deltas_WT_BL_12m_g_ra_reg_no_redundant_feature_importance = "jan22_ALL_deltas_WT_BL_12m_g_ra_no_redundant_feature_importance.csv",
  deltas_WT_BL_12m_g_ra_reg_no_redundant_metrics = "jan22_ALL_deltas_WT_BL_12m_g_ra_no_redundant_metrics.csv"
)
...
create_feature_plot(
  ...
  "drift_fs/figures/deltas/all_jan22/jan22_WT_all_deltas_BL_12m_all_g_feature_plot.pdf")

create_feature_plot(
  all_omic_genus_no_rendundant_features,
  "Top 10 Features - Non Redundant Genus + All omics",
  "drift_fs/figures/deltas/all_jan22/jan22_WT_all_deltas_BL_12m_all_g_no_re_feature_plot.pdf")
...
pdf("drift_fs/figures/deltas/all_jan22/jan22_WT_all_deltas_BL_12m_all_g_12m.pdf", width = 7, height = 7)
...
pdf("drift_fs/figures/deltas/all_jan22/jan22_WT_all_deltas_BL_12m_all_g_no_re_12m.pdf", width = 7, height = 7)
