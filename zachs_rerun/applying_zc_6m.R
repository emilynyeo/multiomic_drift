...
genus_results <- train_and_save_models(
  ...
  "outcome_BMI_fnl_6m",
  train_control,
  "m6_all_omic_g_regression_no_redundant")
...
file_paths <- list(
  # genus
  m6_all_omic_g_ra_regression_beta = "m6_all_omic_g_ra_regression_beta.csv",
  m6_all_omic_g_ra_regression_feature_importance = "m6_all_omic_g_ra_regression_feature_importance.csv",
  m6_all_omic_g_ra_regression_metrics = "m6_all_omic_g_ra_regression_metrics.csv",
  # genus no redundant
  m6_all_omic_g_ra_regression_no_redundant_beta = "m6_all_omic_g_regression_no_redundant_beta.csv",
  m6_all_omic_g_ra_regression_no_redundant_feature_importance = "m6_all_omic_g_regression_no_redundant_feature_importance.csv",
  m6_all_omic_g_ra_regression_no_redundant_metrics = "m6_all_omic_g_regression_no_redundant_metrics.csv"
)
...
genus_titles <- c("All omic BMI 6m Variables (genus ra) - Model Testing RÂ²")
genus_titles_no_redundant <- c("All omic BMI 6m Variables Non Redundant (genus ra) - Model Testing RÂ²")

# Generate combined genus plot
all_omic_plot_genus_ra <- create_plots(all_g_data_list, max_r2, genus_titles)
pdf("drift_fs/figures/m6/jan22_all_g_data_list_6m.pdf", width = 7, height = 7)
...
pdf("drift_fs/figures/m6/jan22_all_g_data_list_no_re_6m.pdf", width = 7, height = 7)
...
create_feature_plot(
  ...
  "drift_fs/figures/m6/jan22_all_m6_genus_feature_plot.pdf")

create_feature_plot(
  all_omic_genus_no_rendundant_features,
  "Top 10 Features - Non Redundant Genus + All omics",
  "drift_fs/figures/m6/jann22_all_m6_genus_no_rendundant_feature_plot.pdf")
